...
const ImageOverlayCard = ({ imgSrc, title, description }) => {
  return (
    ...
    {/* Overlay Text */}
    <div className="absolute -mt-[70px] md:-mt-[110px] xl:-mt-[130px] p-0 md:p-4 w-full flex flex-col justify-end text-ivory-white  bg-[rgba(0,0,0,0.35)] bg-opacity-0 z-10">
      <h2 className="text-lg md:text-xl xl:text-4xl uppercase font-medium px-4 md:pb-1 z-10 text-center">
        {title}
      </h2>
