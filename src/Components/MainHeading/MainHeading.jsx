  ...
  return (
      <>
          <div>
              ...
              <p className='text-text-primary text-center font-montserrat text-[15px] md:text-[20px] xl:text-[40px] font-bold leading-[1] md:tracking-[-1.28px] max-w-4xl mx-auto mt-5 mb-5'>{sub_title}</p>
          </div>
      </>
  )
}
