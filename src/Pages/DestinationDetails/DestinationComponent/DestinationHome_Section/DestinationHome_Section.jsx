    ...
    <>
      ...
      >
        ...
        <div className="relative z-30 flex flex-col justify-around items-center w-full h-full">
          {/* Top Content */}
          <div className="p-5 text-center mt-28">
            <h1 className="text-5xl  md:text-5xl lg:text-[96px] font-salvager text-primary ">
              {destinationName}
            </h1>
            <p className="text-xl  md:text-xl xl:text-6xl text-white mt-14 ">
          ...
          <div className="w-full flex justify-center  p-4">
            <p className="max-w-lg sm:max-w-2xl md:max-w-5xl leading-6 sm:leading-8 lg:leading-10 p-5 bg-gray-700 text-white font-medium text-sm sm:text-lg md:text-xl lg:text-[26px] opacity-80 rounded-md z-10">
