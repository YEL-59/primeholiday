      ...
      >
        <div className="relative z-30 flex flex-col justify-around items-center w-full h-full">
          ...
          <div className="w-full flex justify-center  p-4">
            <p className="max-w-lg sm:max-w-2xl md:max-w-5xl leading-6 sm:leading-8 lg:leading-10 p-5 bg-gray-900 text-white text-sm sm:text-lg md:text-xl lg:text-[26px] opacity-60 rounded-md">
