                  ...
                  <ul className=" list-inside space-y-5">
                    <li>
                      ...
                      <p className="text-lg md:text-xl">
                        {" "}
                        From visiting the Sidab Women's Group to learning about traditional Omani
                    ...
                    <li>
                      <strong className="text-black text-lg md:text-xl">
                        Spectacular Landscapes and Off-Road Adventures:
                         ...
                         <p className="text-lg md:text-xl">The journey through Wadi Bani Auf, <span className="text-primary">...Read more.</span></p>
