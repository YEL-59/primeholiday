...
`,
        ...
        {
            title: "Pricing",
            subtitle: `All prices listed on our website are in US Dollars and inclusive of taxes unless otherwise specified.
...
`,
        },
        {
            ...
            subtitle: `By the Client: Cancellations must be submitted in writing. Refunds will be provided as per our cancellation policy, which varies depending on the package and time of cancellation. Please check our Cancellation & Refund Policy for more information.
...
`,
        },
        {
            ...
            subtitle: `It is the client’s responsibility to obtain adequate travel insurance that covers cancellation, medical expenses, lost luggage, and other potential risks. We strongly recommend that you purchase travel insurance at the time of booking.
`,
        },
        {
            title: "Health & Travel Documentation",
            subtitle: `Clients are responsible for ensuring they meet all visa and health requirements for their chosen destination.
...
`,
        },
        {
            ...
            subtitle: `If you wish to make any changes to your booking after confirmation, we will do our best to accommodate your request, subject to availability. Amendments may incur additional costs.
`,
        },
        {
            title: "Force Majeure",
            subtitle: `Prime Holiday Destinations will not be held liable for any failure to fulfill obligations due to events beyond our control, including but not limited to natural disasters, pandemics, strikes, or government restrictions. In such cases, no refund will be provided, but we will work to reschedule your travel plans where possible.
`,
        },
        {
            title: "Liability",
            subtitle: `We make every effort to ensure that all services provided during your holiday are of high quality and meet our standards. However, we are not responsible for any third-party service failures (such as airlines, hotels, or local operators).
Our liability for any claims, including personal injury or death, is limited to the value of the holiday package booked.
`,
        },
        {
            title: "Complaints",
            subtitle: `If you encounter any issues during your holiday, please inform us immediately, and we will do our best to resolve them. Complaints must be submitted in writing within 14 days of your return.
`,
        },
        {
            title: "Privacy",
            subtitle: `We respect your privacy and handle your personal information in accordance with our Privacy Policy. Your data will only be used for the purposes of fulfilling your booking and improving our services. Your personal information will not be passed to third party.
Please check our Privacy Policy for more information.
`,
        },
        {
            title: "Amendments to Terms & Conditions",
            subtitle: `Prime Holiday Destinations reserves the right to amend these Terms & Conditions at any time. The latest version will always be available on our website. It is your responsibility to review these Terms periodically.
`,
        },
        {
            title: "Governing Law",
